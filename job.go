...
func NewCurrencyConvertJob(from, to string, timeserie timeseries.Timeserie, labels timeseries.Labels, selector tachikoma.Selector) tachikoma.Job {
	labels = labels.Clone()
